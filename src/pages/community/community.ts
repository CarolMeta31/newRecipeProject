...
export class CommunityPage {
  ...
  flag_upload = true;
  flag_play = true;
  constructor(public navCtrl: NavController,private alertCtrl:AlertController, public fileChooser:FileChooser, private mediaCapture:MediaCapture, private transfer:Transfer,public toastCtrl: ToastController, public loadingctrl:LoadingController ,public streamingmedia: StreamingMedia, public actionSheetCtrl:ActionSheetController, private camera:Camera) {
